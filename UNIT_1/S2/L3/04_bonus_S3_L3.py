...
#ESERCITAZIONE1: IMMETTERE UN TESTO, SETTARLO IN MINUSCOLO, PULIRLO DA CARATTERI SPECIALI E CONTEGGIARE LE PAROLE.
print('INIZIO PROGRAMMA 1' \
'')

def calculate_group_mean(the_list, start, end): #Creiamo una funzione che andrà a calcolare una media in cui passeremo: la lista, 
